...
const filters = 'ad,ascii,bi,blur,communism,deepfry,dream,flip,flop,fshify,gay,greyscale,gun,invert,jail,image-mean,pixelate,remove-alpha,sepia,uncover,wanted'.split(',');
